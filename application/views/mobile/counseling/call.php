<h2 class="page-title">Customer Service<small>전화상담신청</small></h2>
...
<article class="container margin-top-20" id="counseling">
    ...
    <fieldset>
        ...
        <div class="form-group form-group-padding margin-bottom-m0">
            <div class="col-xs-6">
                <div class="row margin-bottom-m0">
                    <input type="text" placeholder="출발일" readonly style="border-right:0px;background:#fff;" data-toggle="datepicker" class="form-control input-flat input-big input-no-border" name="travel_start" >
                    <i class="icon-calendar"></i>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="row margin-bottom-m0">
                    <input type="text" placeholder="도착일" readonly style="background:#fff;" data-toggle="datepicker" class="form-control input-flat input-big input-no-border" name="travel_end">
                    <i class="icon-calendar" style="right:15px;"></i>
                </div>
            </div>
        </div>

        <div class="form-group form-group-padding margin-bottom-m0">
            <input placeholder="희망지역" type="text" class="form-control input-flat input-big input-no-border"  name="travel_expect">
        ...
        <div class="text-center margin-top-30">
            <div class="col-xs-6">
                <div class="row margin-bottom-m0">
                    <button type="button" class="btn btn-default btn-big btn-block btn-flat" onclick="history.back(-1);">취소</button>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="row margin-bottom-m0">
                    <button type="submit" class="btn btn-primary btn-big btn-block btn-flat">작성하기</button>
                </div>
            </div>
        </div>
    </fieldset>
