...
<article id="skin-sybqna-write" class="container">
    <div class="write-form-container margin-top-20">
        <?=form_open_multipart("http://www.1000syb.com/board/trstory/write", array("class"=>"form-horizontal", "id"=>"form-board-write", "autocomplete"=>"off"))?>
        <fieldset>
            ...
            <div class="form-group form-group-padding" style="margin-bottom:-1px;">
                <input type="text" class="form-control input-flat input-big input-no-border" id="usr_name" name="usr_name" value="<?=element('usr_name', $post)?>" placeholder="작성자 이름" required="required" data-title="작성자 이름">
            ...
            <div class="form-group form-group-padding" style="margin-bottom:-1px">
                <input type="text" class="form-control input-flat input-big input-no-border" id="post_ext2"  name="post_ext2" value="<?=element('post_ext2', $post)?>" placeholder="허니문 지역을 입력하세요">
