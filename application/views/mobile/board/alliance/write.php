...
<h2 class="page-title">Customer Service<small>제휴문의</small></h2>
...
<article id="skin-sybqna-write" class="container">
    <div class="write-form-container margin-top-20">
        <?=form_open_multipart("http://www.1000syb.com/board/alliance/write", array("class"=>"form-horizontal", "id"=>"form-board-write", "autocomplete"=>"off"))?>
        <fieldset>
            ...
            <div class="form-group form-group-padding margin-bottom-0">
                <div class="col-xs-8">
                    <div class="row margin-bottom-m0">
                        <input type="text" style="border-right:0px;" class="form-control input-flat input-big input-no-border" name="post_title" id="post_title" placeholder="업체명" value="<?=element('post_title', $post)?>" required="required" data-title="업체명" autocomplete="off">
            ...
            <div class="form-group form-group-padding " style="margin-bottom:-1px;">
                <input type="text" class="form-control input-flat input-big input-no-border" id="usr_name" name="usr_name" value="<?=element('usr_name', $post)?>" placeholder="담당자 성명" required="required" data-title="담당자 성명">
                <i class="icon-user-o"></i>
            </div>

            <div class="form-group form-group-padding margin-bottom-m0" style="margin-bottom:-1px;">
                <input type="tel" class="form-control input-flat input-big input-no-border"  name="post_ext1" value="<?=element('post_ext1', $post)?>" placeholder="대표 번호" required="required" data-title="대표 번호">
                <i class="icon-phone-flip"></i>
            </div>

            <div class="form-group form-group-padding margin-bottom-m0" style="margin-bottom:-1px;">
                <input type="tel" class="form-control input-flat input-big input-no-border" data-toggle="phone-check" id="usr_phone" name="usr_phone" value="<?=element('usr_phone', $post)?>" placeholder="담당자 핸드폰" required="required" data-title="담당자 핸드폰">
            ...
            <div class="form-group form-group-padding margin-top-10">
