...
<article id="skin-sybqna-write" class="container">
    <div class="write-form-container margin-top-20">
        <?=form_open_multipart("http://www.1000syb.com/board/sybqna/write", array("class"=>"form-horizontal", "id"=>"form-board-write", "autocomplete"=>"off"))?>
        <fieldset>
            ...
            <div class="form-group form-group-padding margin-bottom-0">
                <div class="col-xs-8">
                    <div class="row margin-bottom-m0">
                        <input type="text" style="border-right:0px;" class="form-control input-flat input-big input-no-border" id="usr_name" name="usr_name" value="<?=element('usr_name', $post)?>" placeholder="작성자 이름" required="required" data-title="작성자 이름">
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="row margin-bottom-m0">
                        <select class="form-control input-flat input-big input-no-border" name="post_ext4">
                            <option value="F" <?=(!element('post_ext4',$post) OR element('post_ext4',$post)=='F')?'selected':''?>>신부</option>
                            <option value="M" <?=(element('post_ext4',$post)=='M')?'selected':''?>>신랑</option>
                        </select>
            ...
            <div class="form-group form-group-padding margin-bottom-m0" style="margin-bottom:-1px;">
                <input type="tel" class="form-control input-flat input-big input-no-border" data-toggle="phone-check" id="usr_phone" name="usr_phone" value="<?=element('usr_phone', $post)?>" placeholder="핸드폰번호를 입력하세요" required="required" data-title="핸드폰번호">
                <i class="icon-iphone"></i>
            </div>

            <div class="form-group form-group-padding margin-bottom-m0" style="margin-bottom:-1px;">
                <input type="email" class="form-control input-flat input-big input-no-border" id="usr_email" name="usr_email" value="<?=element('usr_email', $post)?>" placeholder="이메일 주소를 입력하세요" required="required" data-title="이메일 주소">
                <i class="icon-envelope"></i>
            </div>

            <div class="form-group form-group-padding margin-bottom-m0" style="margin-bottom:-1px;">
                <select class="form-control input-flat input-big input-no-border" name="post_category"  id="post_category">
            ...
            <div class="form-group form-group-padding " style="margin-bottom:-1px;">
                <input type="text" class="form-control input-flat input-big input-no-border" name="post_title" id="post_title" placeholder="글 제목" value="<?=element('post_title', $post)?>" required="required" data-title="제목" autocomplete="off">
                <i class="icon-font"></i>
            </div>
            ...
            <div class="form-group form-group-padding" style="margin-bottom:-1px;">
                <div style="border:1px solid #ddd; background:#fff; padding:15px">
                    <div class="checks">
